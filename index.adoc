...
image:images/andrea.jpeg[erik,200,role="right"]I am a bioinformatician dedicated to developing and applying new methods to analyze ever-larger collections of sequences (also called "pangenomes") in the tree of life.
